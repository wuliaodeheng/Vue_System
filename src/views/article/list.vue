<template>
  <div class="container">
    ...
    <el-table :data="list" border header-cell-class-name="table-header">
      ...
      ></el-table-column>
      <el-table-column prop="author" label="发布者" align="center" min-width="100"></el-table-column>
      <el-table-column prop="view" label="浏览人数" align="center" min-width="100"></el-table-column>
      <el-table-column prop="like" label="收藏人数" align="center" min-width="100"></el-table-column>
