<template>
  <div class="container">
    <div class="cont">
      ...
      <el-input v-model="form.product_name" clearable maxlength="30" style="width: 400px" />
      <img src="../../views/index/components/file.png" style="position: absolute; right: 10px; width: 40%" />
    </div>
    <div class="cont">
      <div class="label">商品描述</div>
      <el-input v-model="form.product_desc" clearable maxlength="30" style="width: 600px" />
    </div>
    <div class="cont">
      ...
      <div class="imgBox">
        ...
        <el-upload
          ...
          :before-upload="uploadFace"
          :limit="1"
          accept="image/*"
          v-if="form.product_imgs.length < 5"
        >
    ...
    <div class="cont">
      ...
      <el-input v-model="form.origin_price" clearable maxlength="8" style="width: 100px" />
    </div>
    <div class="cont">
      <div class="label">销售价</div>
      <el-input v-model="form.sale_price" clearable maxlength="8" style="width: 100px" />
    </div>
    <div class="cont">
